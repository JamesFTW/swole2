...
// Define the root directory to traverse and the output file
const rootDir = './app/components'
const outputFile = './app/components/index.js';

fs.writeFileSync(outputFile, "//THIS FILE IS AUTOGENERATED!!  DON'T EDIT FILE \n");

// Recursively traverse the directory and generate the output string
let outputString = '';
